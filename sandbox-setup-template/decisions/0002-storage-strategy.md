...
Use the boot disk as the sole persistent storage.
Configure it with `--boot-disk-auto-delete=no` to survive instance deletion.
No separate persistent disk needed.
