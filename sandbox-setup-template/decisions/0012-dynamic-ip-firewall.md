...
The sandbox VM exposes SSH to the internet. Even with key-based authentication, restricting access to known IPs significantly reduces attack surface.

Most developers work from dynamic IPs (home ISP, mobile hotspot) that change periodically. Manual firewall management creates friction.
